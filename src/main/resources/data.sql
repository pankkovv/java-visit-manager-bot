...
VALUES (1001, 'pankkovv', 'New admin this bot', 'img/start.jpg');
INSERT INTO profile(id, username, description, path_file)
VALUES (1002, 'eee_kisel', 'Привет! Я Киселева Ульяна, рисую под ником «Кисель». Здесь ты можешь познакомиться с моим творчеством и сделать заказ!', 'img/start.jpg');
...
спасибо этой прекрасной солнечной девушке,пожалуйста не стесняйтесь! заказывайте больше! это того стоит! 😭',
        'img/feedback_eighteen (0).jpg', 1001);
