...
VALUES (1, 'Открытки вообще покорили до глубины души, ' ||
           'эти слова я говорила подруге когда она училась в 11 классе, потому что она хим.био ' ||
           'сдавала общество и биологию и зачастую я даже не понимала о чем она говорит объясняя мне свои термины',
        'img/start.jpg', 1);

INSERT INTO feedback(id, description, path_file, profile_id)
VALUES (2, 'Открытки вообще покорили до глубины души, ' ||
           'эти слова я говорила подруге когда она училась в 11 классе, потому что она хим.био ' ||
           'сдавала общество и биологию и зачастую я даже не понимала о чем она говорит объясняя мне свои термины',
        'img/start.jpg', 1);

INSERT INTO feedback(id, description, path_file, profile_id)
VALUES (3, 'Открытки вообще покорили до глубины души, ' ||
           'эти слова я говорила подруге когда она училась в 11 классе, потому что она хим.био ' ||
           'сдавала общество и биологию и зачастую я даже не понимала о чем она говорит объясняя мне свои термины',
        'img/start.jpg', 1);

INSERT INTO feedback(id, description, path_file, profile_id)
VALUES (4, 'Открытки вообще покорили до глубины души, ' ||
           'эти слова я говорила подруге когда она училась в 11 классе, потому что она хим.био ' ||
           'сдавала общество и биологию и зачастую я даже не понимала о чем она говорит объясняя мне свои термины',
        'img/start.jpg', 1);

INSERT INTO feedback(id, description, path_file, profile_id)
VALUES (5, 'Открытки вообще покорили до глубины души, ' ||
           'эти слова я говорила подруге когда она училась в 11 классе, потому что она хим.био ' ||
           'сдавала общество и биологию и зачастую я даже не понимала о чем она говорит объясняя мне свои термины',
        'img/start.jpg', 1);
...
INSERT INTO feedback(id, description, path_file, profile_id)
VALUES (6, 'Открытки вообще покорили до глубины души, ' ||
           'эти слова я говорила подруге когда она училась в 11 классе, потому что она хим.био ' ||
           'сдавала общество и биологию и зачастую я даже не понимала о чем она говорит объясняя мне свои термины',
        'img/start.jpg', 1);

INSERT INTO feedback(id, description, path_file, profile_id)
VALUES (7, 'Открытки вообще покорили до глубины души, ' ||
           'эти слова я говорила подруге когда она училась в 11 классе, потому что она хим.био ' ||
           'сдавала общество и биологию и зачастую я даже не понимала о чем она говорит объясняя мне свои термины',
        'img/start.jpg', 1);

INSERT INTO feedback(id, description, path_file, profile_id)
VALUES (8, 'Открытки вообще покорили до глубины души, ' ||
           'эти слова я говорила подруге когда она училась в 11 классе, потому что она хим.био ' ||
           'сдавала общество и биологию и зачастую я даже не понимала о чем она говорит объясняя мне свои термины',
        'img/start.jpg', 1);

INSERT INTO feedback(id, description, path_file, profile_id)
VALUES (9, 'Открытки вообще покорили до глубины души, ' ||
           'эти слова я говорила подруге когда она училась в 11 классе, потому что она хим.био ' ||
           'сдавала общество и биологию и зачастую я даже не понимала о чем она говорит объясняя мне свои термины',
        'img/start.jpg', 1);